...
#
# Generated by export_simulation on Fri Nov 01 22:25:05 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './fmc_fifo.sh' script.

./fmc_fifo.sh -reset_run
...
./fmc_fifo.sh -noclean_files

For more information on the script, please type './fmc_fifo.sh -help'.
