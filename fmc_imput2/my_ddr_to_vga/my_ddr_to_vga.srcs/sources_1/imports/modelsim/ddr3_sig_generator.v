...
`ifdef pixel
assign	rd_burst_len=RESOLUTION*RESOLUTION/16;
`else
...
reg [3:0] next_state;
 reg [21:0] wr_burst_addr_counter;//4096*4096*2/16
 reg [20:0] rd_burst_addr_counter; 
 reg [20:0] rd_burst_data_counter;
 reg [21:0] rd_burst_addr_counter_full; 
 reg [21:0] rd_burst_data_counter_full;
reg app_wdf_wren_r;
reg app_en_r;
...
always @(posedge clk, negedge rst_n)
 ...
 reg [6:0] ddr3_rd_en_counter_full;
always @(posedge clk, negedge rst_n)
	if(~rst_n)	
