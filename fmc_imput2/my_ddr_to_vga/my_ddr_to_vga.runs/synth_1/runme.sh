...
HD_PWD='C:/Users/gyz/Desktop/ddrtovga/fmc_imput2/my_ddr_to_vga/my_ddr_to_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddrtovga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddrtovga_top.tcl
