...
HD_PWD='C:/Users/gyz/Desktop/ddrtovga/fmc_imput2/my_ddr_to_vga/my_ddr_to_vga.runs/fifo_256_ddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_256_ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_256_ddr.tcl
