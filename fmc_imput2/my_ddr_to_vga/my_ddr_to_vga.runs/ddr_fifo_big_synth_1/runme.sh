...
HD_PWD='C:/Users/gyz/Desktop/ddrtovga/mine/my_ddr_to_vga/my_ddr_to_vga.runs/ddr_fifo_big_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr_fifo_big.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr_fifo_big.tcl
