...
HD_PWD='C:/Users/gyz/Desktop/ddrtovga/mine/my_ddr_to_vga/my_ddr_to_vga.runs/sd_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sd_fifo.tcl
