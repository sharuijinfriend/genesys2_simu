...
HD_PWD='C:/Users/gyz/Desktop/ddrtovga/mine/my_ddr_to_vga/my_ddr_to_vga.runs/DDR3_CONTROL_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR3_CONTROL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR3_CONTROL.tcl
