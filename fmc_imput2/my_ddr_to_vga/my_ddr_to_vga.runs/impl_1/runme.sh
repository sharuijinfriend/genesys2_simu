...
HD_PWD='C:/Users/gyz/Desktop/ddrtovga/fmc_imput2/my_ddr_to_vga/my_ddr_to_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ddrtovga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ddrtovga_top.tcl -notrace
