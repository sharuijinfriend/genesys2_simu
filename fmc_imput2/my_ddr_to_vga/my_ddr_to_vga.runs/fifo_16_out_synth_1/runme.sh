...
HD_PWD='C:/Users/gyz/Desktop/ddrtovga/fmc_imput2/my_ddr_to_vga/my_ddr_to_vga.runs/fifo_16_out_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_16_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_16_out.tcl
