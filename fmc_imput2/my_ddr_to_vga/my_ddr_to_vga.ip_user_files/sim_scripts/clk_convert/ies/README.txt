...
#
# Generated by export_simulation on Tue Nov 05 17:04:57 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './clk_convert.sh' script.

./clk_convert.sh -reset_run
...
./clk_convert.sh -noclean_files

For more information on the script, please type './clk_convert.sh -help'.
